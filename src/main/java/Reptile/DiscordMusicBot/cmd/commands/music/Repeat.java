...
public class Repeat implements ICommand {
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        boolean isRepeat = !musicManager.scheduler.repeating;
        musicManager.scheduler.repeating = isRepeat;
        event.replyFormat("The player has been set to **%s**", isRepeat ? "repeating" : "not repeating").queue();
